...
function SalesChart({bookings, numDays}) {
  ...
  return (
    ...
    <AreaChart data={data}>
      ...
      <Area dataKey="totalSales" stroke={colors.totalSales.stroke} fill={colors.totalSales.fill} type='monotone' strokeWidth={2} />
      <Area dataKey="extrasSales" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} type='monotone' strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
    </StyledSalesChart>
  );
